...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "O3", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.Ozone);
    endpoints.addEndpoint("3", "CO", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonMonoxide);
    endpoints.addEndpoint("4", "NO", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.nitricOxide);
}
